...
import 'package:flutter_ucrop/src/utils.dart';
...
class AndroidUiSettings {
  ...
  Map<String, dynamic> toMap() => {
        ...
        'android.toolbar_height': this.toolbarHeight,
        'android.toolbar_text_size': this.toolbarTextSize,
...
class IOSUiSettings {
  ...
  final CropAspectRatioPreset initAspectRatioPreset;
  ...
  Map<String, dynamic> toMap() => {
        ...
        'ios.init_aspect_ratio_preset':
            aspectRatioPresetName(this.initAspectRatioPreset)
      };
}
